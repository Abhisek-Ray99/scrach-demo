 ...
 */
const TurnDegreesAntiClockBlock = ({
  id, // Receive ID
  degrees = 15,
  ...
  const handleDragStart = (e) => {
    if (onDragStart) {
      onDragStart(e, BLOCK_TYPES.MOTION_TURN_DEGREES_ANTI_CLOCK);
    }
  };
  ...
  return (
    ...
    >
      {/* Block Content */}
      <RotateCcw size={16} className="flex-shrink-0" color='#4DB4F7' />
...
export default TurnDegreesAntiClockBlock;